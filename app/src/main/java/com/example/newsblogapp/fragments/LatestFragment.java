...
public class LatestFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        fireBaseMethods.getAllPosts("Latest", new PostsListCallBack()
        {
            @Override
    ...
    private void initViews(View view)
    {
        ...
        progressBar = view.findViewById(R.id.progressBarLatestFragment);
        fireBaseMethods = new FireBaseMethods(context, progressBar);
        recyclerView = view.findViewById(R.id.recyclerViewLatestFragment);

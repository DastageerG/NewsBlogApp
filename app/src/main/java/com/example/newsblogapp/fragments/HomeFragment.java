...
public class HomeFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        fireBaseMethods.getAllPosts("Top", new PostsListCallBack()
        {
            @Override
    ...
    private void initViews(View view)
    {
        ...
        progressBar = view.findViewById(R.id.progressBarHomeFragment);
        fireBaseMethods = new FireBaseMethods(context, progressBar);
        recyclerView = view.findViewById(R.id.recyclerViewHomeFragment);

...
public class PakistanFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        fireBaseMethods.getAllPosts("Pakistan", new PostsListCallBack()
        {
            @Override
    ...
    private void initViews(View view)
    {
        ...
        progressBar = view.findViewById(R.id.progressBarPakistanFragment);
        fireBaseMethods = new FireBaseMethods(context, progressBar);
        recyclerView = view.findViewById(R.id.recyclerViewPakistanFragment);

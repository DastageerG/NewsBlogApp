...
public class SportsFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        fireBaseMethods.getAllPosts("Sports", new PostsListCallBack()
        {
            @Override
    ...
    private void initViews(View view)
    {
        ...
        progressBar = view.findViewById(R.id.progressBarSportsFragment);
        fireBaseMethods = new FireBaseMethods(context, progressBar);
        recyclerView = view.findViewById(R.id.recyclerViewSportsFragment);

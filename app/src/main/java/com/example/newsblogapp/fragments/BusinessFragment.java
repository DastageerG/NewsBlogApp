...
public class BusinessFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        fireBaseMethods.getAllPosts("Business", new PostsListCallBack()
        {
            @Override
    ...
    private void initViews(View view)
    {
        ...
        progressBar = view.findViewById(R.id.progressBarBusinessFragment);
        fireBaseMethods = new FireBaseMethods(context, progressBar);
        recyclerView = view.findViewById(R.id.recyclerViewBusinessFragment);
